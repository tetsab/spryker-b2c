...
abstract class PyzAntelope implements ActiveRecordInterface
{
    ...
    /**
     * The value for the fk_location field.
     *
     * @var        int|null
     */
    protected $fk_location;

    /**
     * @var        ChildPyzAntelopeLocation
     */
    protected $aPyzAntelopeLocation;
    ...
    /**
     * Get the [fk_location] column value.
     *
     * @return int|null
     */
    ...
    /**
     * Set the value of [fk_location] column.
     *
     * @param int|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setFkLocation($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if (($this->isNew() && $hasDefaultValue) || $this->fk_location !== $v) {
            $this->fk_location = $v;
            $this->modifiedColumns[PyzAntelopeTableMap::COL_FK_LOCATION] = true;
        }

        if ($this->aPyzAntelopeLocation !== null && $this->aPyzAntelopeLocation->getIdLocation() !== $v) {
            $this->aPyzAntelopeLocation = null;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PyzAntelopeTableMap::translateFieldName('FkLocation', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fk_location = (null !== $col) ? (int) $col : null;
            ...
            return $startcol + 4; // 4 = PyzAntelopeTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aPyzAntelopeLocation !== null && $this->fk_location !== $this->aPyzAntelopeLocation->getIdLocation()) {
            $this->aPyzAntelopeLocation = null;
        }
    }
    ...
    protected function doSave(ConnectionInterface $con): int
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPyzAntelopeLocation !== null) {
                if ($this->aPyzAntelopeLocation->isModified() || $this->aPyzAntelopeLocation->isNew()) {
                    $affectedRows += $this->aPyzAntelopeLocation->save($con);
                }
                $this->setPyzAntelopeLocation($this->aPyzAntelopeLocation);
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(PyzAntelopeTableMap::COL_FK_LOCATION)) {
            $modifiedColumns[':p' . $index++]  = 'fk_location';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'color':
                        ...
                        break;
                    case 'fk_location':
                        $stmt->bindValue($identifier, $this->fk_location, PDO::PARAM_INT);
    ...
    public function toArray(string $keyType = TableMap::TYPE_FIELDNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPyzAntelopeLocation) {

                switch ($keyType) {
                    case TableMap::TYPE_CAMELNAME:
                        $key = 'pyzAntelopeLocation';
                        break;
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'pyz_antelope_location';
                        break;
                    default:
                        $key = 'PyzAntelopeLocation';
                }

                $result[$key] = $this->aPyzAntelopeLocation->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(PyzAntelopeTableMap::COL_FK_LOCATION)) {
            $criteria->add(PyzAntelopeTableMap::COL_FK_LOCATION, $this->fk_location);
        }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setFkLocation($this->getFkLocation());
        if ($makeNew) {
            $copyObj->setNew(true);
    ...
    /**
     * Declares an association between this object and a ChildPyzAntelopeLocation object.
     *
     * @param ChildPyzAntelopeLocation|null $v
     * @return $this The current object (for fluent API support)
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function setPyzAntelopeLocation(ChildPyzAntelopeLocation $v = null)
    {
        if ($v === null) {
            $this->setFkLocation(NULL);
        } else {
            $this->setFkLocation($v->getIdLocation());
        }

        $this->aPyzAntelopeLocation = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildPyzAntelopeLocation object, it will not be re-added.
        if ($v !== null) {
            $v->addPyzAntelope($this);
        }
    ...
    /**
     * Get the associated ChildPyzAntelopeLocation object
     *
     * @param ConnectionInterface $con Optional Connection object.
     * @return ChildPyzAntelopeLocation|null The associated ChildPyzAntelopeLocation object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function getPyzAntelopeLocation(?ConnectionInterface $con = null)
    {
        if ($this->aPyzAntelopeLocation === null && ($this->fk_location != 0)) {
            $this->aPyzAntelopeLocation = ChildPyzAntelopeLocationQuery::create()->findPk($this->fk_location, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPyzAntelopeLocation->addPyzAntelopes($this);
             */
        }

        return $this->aPyzAntelopeLocation;
    }
    ...
    {
        if (null !== $this->aPyzAntelopeLocation) {
            $this->aPyzAntelopeLocation->removePyzAntelope($this);
        }
        $this->id_antelope = null;
        $this->name = null;
        $this->color = null;
        $this->fk_location = null;
        $this->alreadyInSave = false;
        $this->clearAllReferences();
        $this->resetModified();
        $this->setNew(true);
